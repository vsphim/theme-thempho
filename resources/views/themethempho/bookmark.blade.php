            ...
            <section class="l-section empty:hidden">
                <div class="pb-5 sticky top-[--home-header-height] bg-black lg:bg-primary-bg/90 duration-500 z-zTabSticky">
                    <div class="flex flex-wrap items-center gap-[10px] w-full overflow-x-auto scrollbar-hidden">
                        ...
                        <button class="a-button flex items-center justify-center relative [&amp;:not(:disabled)]:active:opacity-[0.92] duration-200 whitespace-nowrap disabled:bg-primary-btn/40 disabled:text-primary-text/40 active:scale-[0.98] disabled:active:scale-100 lg:h-9 lg:gap-2 lg:px-4 lg:font-normal lg:text-[0.875rem] h-8 gap-2 px-4 text-[0.875rem] rounded-lg bg-white/100 hover:bg-white/90 text-black !font-medium" aria-label="button-icon">Bookmark</button>
